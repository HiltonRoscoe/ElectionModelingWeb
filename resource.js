window.resource = {
    ...
    {
        title: 'QUICK START',
        text: '<img src=\"images/quick_start.png\" usemap="#manual_link"><map name="manual_link"><area shape="rect" coords="520,320,815,430" target="_blank" href="manuals/bpmn_manual.pdf" alt="BPMN Quick Reference Guide"></map></br><p style="text-align:center; font-family:helvetica, arial, verdana, sans-serif; font-size:15px">Cameo Business Modeler Process Portal</br>&#169; 2014 No Magic, Inc.</p>'
    },
    logo_panel :
    {
        logo : 
